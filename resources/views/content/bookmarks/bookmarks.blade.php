    ...
    <div class="card-body">
      <div class="row mb-2 align-items-center">
        <div class="col-1" >
          ...
          <img src="{{ $bookmark->user->profile_image ? asset('storage/' . $bookmark->user->profile_image) : asset('assets/img/avatars/1.png') }}"  alt="Profile Picture" class="rounded-circle" width="50px">
        </div>
        <div class="col">
